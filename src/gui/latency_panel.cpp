...
void LatencyPanel::init()
{
	...
	_input_spin->value_changed.connect (bind (slot (*this,  &LatencyPanel::on_spin_change), ID_InputLatency));
	...
	_output_spin->value_changed.connect (bind (slot (*this,  &LatencyPanel::on_spin_change), ID_OutputLatency));
